...
//    public void the_system_should_display_an_error_message_indicating_employee_name(String message) throws Exception {
//        try {
...
public class PerformanceDefinition {
    ...
    public void the_user_clicks_the_add_button() {
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(10));
        WebElement addTrackerButton = wait
            .until(ExpectedConditions.elementToBeClickable(performancePages.addTrackerButton));
        addTrackerButton.click();
        LogManagers.logInfo("Clicked on Add Button");
    }
